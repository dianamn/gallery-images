...
<div class="hugeit-tracking-optin">
    <div class="hugeit-tracking-optin-left">
        ...
        <div class="hugeit-tracking-optin-info">
            <div class="hugeit-tracking-optin-header"><?php _e('Let us know how you wish to better this plugin! ', 'hugeit-image-gallery'); ?></div>
            ...
            <div>
                <a href="<?php echo $optin_url; ?>"
                   class="hugeit-tracking-optin-button"><?php _e('Yes, sure', 'hugeit-image-gallery'); ?></a><a
